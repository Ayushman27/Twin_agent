        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <span className="px-2 py-0.5 border border-[#00ff4144] bg-[#00ff4110] text-[#00ff41] text-[10px] font-mono tracking-wider hidden sm:inline-block">
                EMPLOYEE_PORTAL
              </span>
            </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="pt-8 border-t border-zinc-900 grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="font-mono text-[10px] text-[#00ff41] tracking-widest uppercase">New User</span>
                </div>
                <h3 className="text-white font-bold text-base group-hover:text-[#00ff41] transition-colors flex items-center gap-1">
                  Register Yourself <ArrowRight className="w-4 h-4 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all" />
                </h3>
                <p className="text-xs text-zinc-400 mt-1 leading-normal">
                  Find your company in the directory and create your employee profile to link with your team.
                </p>
              </Link>
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="font-mono text-[10px] text-zinc-400 tracking-widest uppercase">Existing User</span>
                </div>
                <h3 className="text-white font-bold text-base group-hover:text-white transition-colors flex items-center gap-1">
                  Employee Login <ArrowRight className="w-4 h-4 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all" />
                </h3>
                <p className="text-xs text-zinc-400 mt-1 leading-normal">
                  Sign in with your registered employee credentials to access your workspace and AI twins.
                </p>
              </Link>
            </div>
            ...
            <div className="pt-2">
              ...
              >
                <span>Looking for the Company Portal? Go to localhost:3000</span>
